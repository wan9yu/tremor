# tremor radar — calibration log (archive: rounds 1–19)

Rounds 1–19 of the append-only round-by-round record behind the registry in **[radar.md](radar.md)**.
Split out by `tools/roll_radar_log.py` once the live log crossed its self-set roll threshold (2,000 lines).
Current rounds (20+) are in **[radar-log.md](radar-log.md)**.
